...
class GetAllObjsTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.epoch_list = [random_epoch(), random_epoch()]
        self.epoch_dict = {"a": random_epoch(), 123: random_epoch()}
    ...
    def test__get_all_objs__iter_spiketrain(self):
        targ = self.spiketrain_list
        value = iter([self.spiketrain_list[0], self.spiketrain_list[1]])
    ...
    def test__get_all_objs__nested_dict_spiketrain(self):
        targ = self.spiketrain_list
        value = {"a": self.spiketrain_list[0], "b": {"c": self.spiketrain_list[1]}}
    ...
    def test__get_all_objs__nested_many_spiketrain(self):
        targ = self.spiketrain_list
        value = {"a": [self.spiketrain_list[0]], "b": iter([self.spiketrain_list[1]])}
    ...
    def test__get_all_objs__unit_spiketrain(self):
        value = neo.core.Group(self.spiketrain_list, name="Unit")
        targ = self.spiketrain_list
...
class ExtractNeoAttrsTestCase(unittest.TestCase):
    ...
    def test__extract_neo_attrs__spiketrain_noarray(self):
        ...
        for i, attr in enumerate(
            neo.SpikeTrain._necessary_attrs + neo.SpikeTrain._recommended_attrs
        ):
        ...
        res10 = nt.extract_neo_attributes(
            obj, parents=False, skip_array=True, child_first=True
        )
        res20 = nt.extract_neo_attributes(
            obj, parents=False, skip_array=True, child_first=False
        )
        res01 = nt.extract_neo_attributes(obj, parents=True, skip_array=True)
        res11 = nt.extract_neo_attributes(
            obj, parents=False, skip_array=True, child_first=True
        )
    ...
    def test__extract_neo_attrs__spiketrain_noarray_skip_none(self):
        ...
        res00 = nt.extract_neo_attributes(
            obj, parents=False, skip_array=True, skip_none=True
        )
        res10 = nt.extract_neo_attributes(
            obj, parents=False, skip_array=True, child_first=True, skip_none=True
        )
        res20 = nt.extract_neo_attributes(
            obj, parents=False, skip_array=True, child_first=False, skip_none=True
        )
        res01 = nt.extract_neo_attributes(
            obj, parents=True, skip_array=True, skip_none=True
        )
        res11 = nt.extract_neo_attributes(
            obj, parents=False, skip_array=True, child_first=True, skip_none=True
        )
    ...
    def test__extract_neo_attrs__epoch_noarray(self):
        ...
        targ = copy.deepcopy(obj.annotations)
        for i, attr in enumerate(
            neo.Epoch._necessary_attrs + neo.Epoch._recommended_attrs
        ):
            targ[attr[0]] = getattr(obj, attr[0])
        targ = strip_iter_values(targ)
    ...
    def test__extract_neo_attrs__event_noarray(self):
        ...
        targ = copy.deepcopy(obj.annotations)
        for i, attr in enumerate(
            neo.Event._necessary_attrs + neo.Event._recommended_attrs
        ):
            targ[attr[0]] = getattr(obj, attr[0])
        targ = strip_iter_values(targ)
    ...
    def test__extract_neo_attrs__spiketrain_parents_empty_array(self):
        ...
        res111 = nt.extract_neo_attributes(
            obj, parents=True, skip_array=False, child_first=True
        )
        res211 = nt.extract_neo_attributes(
            obj, parents=True, skip_array=False, child_first=False
        )
    ...
    def test__extract_neo_attrs__spiketrain_noparents_noarray(self):
        ...
        res1 = nt.extract_neo_attributes(
            obj, parents=False, skip_array=True, child_first=True
        )
        res2 = nt.extract_neo_attributes(
            obj, parents=False, skip_array=True, child_first=False
        )
    ...
    def test__extract_neo_attrs__spiketrain_parents_childfirst_noarray(self):
        ...
        for i, attr in enumerate(
            neo.Block._necessary_attrs + neo.Block._recommended_attrs
        ):
            targ[attr[0]] = getattr(blk, attr[0])

        targ.update(copy.deepcopy(seg.annotations))
        for i, attr in enumerate(
            neo.Segment._necessary_attrs + neo.Segment._recommended_attrs
        ):
        ...
        res1 = nt.extract_neo_attributes(
            obj, parents=True, skip_array=True, child_first=True
        )
    ...
    def test__extract_neo_attrs__spiketrain_parents_parentfirst_noarray(self):
        ...
        res0 = nt.extract_neo_attributes(
            obj, parents=True, skip_array=True, child_first=False
        )
