...
class WeightedPhaseLagIndexTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.files_to_download_ground_truth = (
            (
                "ground_truth_WPLI_from_ft_connectivity_wpli_" "with_real_LFPs_R2G.csv",
                "4d9a7b7afab7d107023956077ab11fef",
            ),
            (
                "ground_truth_WPLI_from_ft_connectivity_wpli_"
                "with_artificial_LFPs.csv",
    ...
    def setUp(self):
        ...
        dataset1_artificial = scipy.io.loadmat(
            f"{self.tmp_path.parent}/" f"{self.files_to_download_artificial[0][0]}",
            squeeze_me=True,
        )
        dataset2_artificial = scipy.io.loadmat(
            f"{self.tmp_path.parent}/" f"{self.files_to_download_artificial[1][0]}",
            squeeze_me=True,
        )
        # get relevant values
        ...
        self.wpli_ground_truth_ft_connectivity_wpli_real = np.loadtxt(
            f"{self.tmp_path.parent}/" f"{self.files_to_download_ground_truth[0][0]}",
            delimiter=",",
            dtype=np.float64,
        )
        self.wpli_ground_truth_ft_connectivity_artificial = np.loadtxt(
            f"{self.tmp_path.parent}/" f"{self.files_to_download_ground_truth[1][0]}",
            delimiter=",",
            dtype=np.float64,
        )
